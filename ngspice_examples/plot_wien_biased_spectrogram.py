...
# Restrict output to fully-valid frames (window entirely inside the signal):
# the default returns frames whose window straddles either edge, which shows
# up as a broadband flash in the spectrogram from the implicit zero-padding.
